...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('examinations', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->foreignId('examination_types_id')->constrained(table:'examination_types')->onDelete(action:'cascade');
            ...
            $table->foreignId('campus_id')->constrained(table:'campuses')->onDelete(action:'cascade');
            $table->timestamps();
        });
